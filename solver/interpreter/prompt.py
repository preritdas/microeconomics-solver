...
When plotting, it's best to label your graphs, especially if/when you choose to create multiple. You can insert the label in the title of your plot, and reference it in a final text response.
